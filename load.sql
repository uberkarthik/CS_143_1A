...
LOAD DATA LOCAL INFILE '~/data/movierating.del' INTO TABLE MovieRating FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE '~/data/sales.del' INTO TABLE Sales FIELDS TERMINATED BY ',';
